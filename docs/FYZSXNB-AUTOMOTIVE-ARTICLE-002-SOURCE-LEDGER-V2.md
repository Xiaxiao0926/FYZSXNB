# FYZSXNB Automotive Article 002 — Source Ledger v2

**Tiering (v2, corrected):**
- **Tier 1** = OEM / official manufacturer bulletin / official law / regulator / original primary document
- **Tier 2** = recognized technical organization / equipment manufacturer / industry technical standard
...
|---|---|---|---|---|---|---|
| S1 | Autostat — 6% parc (Sep 2025) | 3 | C1 | Chinese brands ≈6% of Russian passenger parc | No ADAS repair-volume claim | Yes |
| S2 | Autostat — corporate fleet leadership | 3 | C2 | Chinese brands lead corporate fleets among foreign makes | Not mileage/repair-frequency/ADAS-volume proof | Yes |
| S3 | RBC Tyumen (Sep 2024) | 3 | C3 | Independent СТО struggle narrative documented | Not per-workshop or per-model guarantee | Yes |
| S4 | abreview / Iz.ru | 3 | C3 | Dealer-refusal market signal | Same as S3 | Yes |
| S5 | 360.ru | 3 | C3 | Service-system tension narrative (Chinese autoprom) | Same as S3 | Yes |
| S6 | Autoglass Russia — service listing | 3 | C9 | Glass providers offering camera calibration (service emergence) | Not coverage statistics; service listing only | Yes |
| S7 | Elektroman.pro — Zeekr radar calibration (Moscow) | 3 | C10 | One concrete Chinese-model calibration offering exists (Zeekr, Moscow) | Single listing; no statement about other Chinese brands | Yes |
| S8 | gipix-lite — СТО ADAS business case | 3 | C11 | One trade source discusses training/utilization/payback as adoption considerations | Directional; not national statistics | Yes |
| S9 | AAA (Australia) ADAS Code of Conduct (2025) | 2 | C5 | Industry-standard principle: calibration when sensor/ADAS alignment disrupted | Not a specific-OEM or Chinese-OEM procedure | Yes |
...
| S17 | ГАРАНТ news | 2 | C4A | Legal news service confirmation of obligations | Secondary confirmation | Yes |
| S18 | Autonews.ru | 3 | C4B | Media framing linking 266-FZ to carmaker/СТО data sharing | Media report; not legal text | Yes |
| S19 | Lidings legal update | 2 | C4A/C4B | Law-firm analysis of obligations scope | Analysis, not official text | Yes |
| S20 | Bosch Diagnostics product page | 2 | C8 | Vendor capability: ADAS calibration systems | Not proof of Chinese-VIN coverage | Yes |
| S21 | HELLA camera/radar calibration | 2 | C8 | Vendor capability | Same as S20 | Yes |
| S22 | LAUNCH X-431 ADAS | 2 | C8 | Vendor capability: multi-brand ADAS frames/software | Same as S20 | Yes |
